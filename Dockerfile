...
#docker rm -f material_matrix && docker pull f80hub/material_matrix_x86:latest && docker run --restart=always -p 5000:5000 --name material_matrix -d f80hub/material_matrix_x86:latest "ssl"
