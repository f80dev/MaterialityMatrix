...
#docker rm -f material_matrix && docker pull f80hub/material_matrix_x86:latest && docker run --restart=always -v /datas:/app/datas -v /clustering:/app/clustering -p 5000:5000 --name clusterbench -d f80hub/material_matrix_x86:latest "ssl"
